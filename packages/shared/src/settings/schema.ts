...
export const settingsSchema = {
  ...
  "sections.rules": setting({
    ...
    label: "Section rules",
    help: "Which Threads each Section holds: conditions over Thread state and Group, checked in Section order on this device, then the Section's judge statement for what the conditions leave open. Each rule says where its Section shows: the stream, the nav, or both. The shipped four are rows like any other.",
  }),
