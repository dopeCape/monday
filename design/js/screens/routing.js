...
import { ic, agentDock, initials } from "../components.js";
  ...
  const grp = g => `
    <div class="grp">
      <div class="grp-h">
        ...
        <span class="tag ai">${ic("ph-sparkle", "fill")} ${Math.round(g.conf * 100)}% confident</span>
        <div class="acts"><button class="btn sm">${ic("ph-sparkle")} Change rule</button><button class="btn sm icon">${ic("ph-dots-three")}</button></div>
      </div>
    ...
    <div class="page-wrap">
      <div class="page-in">
        <div class="page-head">
          ...
          <div class="acts"><button class="btn outline">${ic("ph-arrows-clockwise")} Re-run on inbox</button><button class="btn primary">${ic("ph-sparkle", "fill")} New group</button></div>
        </div>
        <div class="two">
          <div class="tree">${routing.map(grp).join("")}</div>
          <aside>
            <div class="side-card">
              <h3>${ic("ph-sparkle", "fill")} Ask for a group</h3>
              <div class="ask">${ic("ph-sparkle", "fill")}<input placeholder="e.g. a Support inbox for anything from customers" /><button class="send">${ic("ph-arrow-up", "bold")}</button></div>
            ...
            <div class="side-card">
              <h3>${ic("ph-question")} Low confidence <span class="tag warn" style="margin-left:-2px">2</span></h3>
            ...
            <div class="side-card">
              <h3>${ic("ph-list-magnifying-glass")} Recently routed</h3>
