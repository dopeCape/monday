...
- A Workflow the Agent creates, changes or switches renders as the Workflow card: the compact flow of the Workflows page (trigger, conditions, each Step's glyph, summary and approval), and for an edit what is new, changed and removed (`workflows.md`, "The agent's Workflow card").
